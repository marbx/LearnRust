...
//   test tests::bench_35_words_contains           ... bench:          58 ns/iter (+/- 17)
//   test tests::bench_35_words_hashmap_mutable    ... bench:          60 ns/iter (+/- 4)
//   test tests::bench_35_words_hashmap_static_phf ... bench:          71 ns/iter (+/- 0)
//   test tests::bench_35_words_hashset_lazy       ... bench:          59 ns/iter (+/- 4)
//   test tests::bench_35_words_hashset_static_phf ... bench:          70 ns/iter (+/- 2)
//   test tests::bench_35_words_match              ... bench:           0 ns/iter (+/- 0)
//   test tests::bench_35_words_matchmacro         ... bench:           0 ns/iter (+/- 0)
//   test tests::bench_85_words_binary_search      ... bench:         100 ns/iter (+/- 5)
//   test tests::bench_85_words_contains           ... bench:         140 ns/iter (+/- 4)
//   test tests::bench_85_words_hashmap_mutable    ... bench:          58 ns/iter (+/- 0)
//   test tests::bench_85_words_hashmap_static_phf ... bench:          70 ns/iter (+/- 1)
//   test tests::bench_85_words_hashset_lazy       ... bench:          59 ns/iter (+/- 3)
//   test tests::bench_85_words_hashset_static_phf ... bench:          70 ns/iter (+/- 1)
//   test tests::bench_85_words_match              ... bench:         121 ns/iter (+/- 21)
//   test tests::bench_85_words_matchmarco         ... bench:         117 ns/iter (+/- 9)
...
mod tests {
    ...
    #[bench]
    fn bench_35_words_hashset_static_phf(b: &mut Bencher) {
        b.iter(|| {
    ...
    #[bench]
    fn bench_85_words_hashset_static_phf(b: &mut Bencher) {
        b.iter(|| {
    ...
    #[bench]
    fn bench_35_words_hashset_lazy(b: &mut Bencher) {
        b.iter(|| {
    ...
    #[bench]
    fn bench_85_words_hashset_lazy(b: &mut Bencher) {
        b.iter(|| {
    ...
    #[bench]
    fn bench_35_words_hashmap_mutable(b: &mut Bencher) {
